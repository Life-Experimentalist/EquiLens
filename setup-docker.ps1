...
# ============================================================================
# Examples:
#   $EQUILENS_IMAGE = "vkrishna04/equilens:v2.0.0"           # Specific version
#   $EQUILENS_IMAGE = "ghcr.io/vkrishna04/equilens:latest"   # GitHub Registry
#   $EQUILENS_IMAGE = "mycompany/equilens:custom"            # Custom build
# ============================================================================
